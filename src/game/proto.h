...
int proto_read_protoUpdateData(Object* obj, DB_FILE* stream, bool readQuality = false);
int proto_write_protoUpdateData(Object* obj, DB_FILE* stream, bool writeQuality = false);
